  ...
  public partial class DateTimeDragControl : UserControl
  {
    ...
    private bool SetDraggedValue(int delta)
    {
      ...
      try {
        switch (this.rectContents[this.draggedDigit])
        {
          case Components.Day: this.dateTime = this.dateTime.AddDays(delta); break;
          case Components.Month: this.dateTime = this.dateTime.AddMonths(delta); break;
          case Components.Year: this.dateTime = this.dateTime.AddYears(delta); break;

          case Components.Hours: this.dateTime = this.dateTime.AddHours(delta); break;
          case Components.Minutes: this.dateTime = this.dateTime.AddMinutes(delta); break;
          case Components.Seconds: this.dateTime = this.dateTime.AddSeconds(delta); break;
        }
      }
